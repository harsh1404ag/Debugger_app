  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <BGPattern variant="grid" mask="fade-edges" size={40} fill="rgba(139, 92, 246, 0.08)" className="opacity-60" />
        <BGPattern variant="dots" mask="fade-center" size={60} fill="rgba(99, 102, 241, 0.06)" className="opacity-40" />
        <BGPattern variant="diagonal-stripes" mask="fade-y" size={80} fill="rgba(168, 85, 247, 0.03)" className="opacity-30" />
